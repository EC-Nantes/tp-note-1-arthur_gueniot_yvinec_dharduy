...
void testPolygone() {
  ...
  p1.setX(15);
  std::cout << "Après modification du point, le point du polydone doit être "
               "identique à avant"
            << std::endl;
  std::cout << poly1 << std::endl;
  ...
  /** Test de copie de polygone, Le polygone doit afficher l'identique de la
   * copie*/
  Polygone<int> poly3(poly1);
  std::cout << "Affichage du polygone 3 créé par recopiede polygone 1"
            << std::endl;
...
void menu_deroulant(void) {
  ...
  while (leave == 1) {
    ...
    std::cout
        << "Menu déroulant du projet parcelle, choisissez l'action à réaliser "
           "en indiquant le numéro de l'action puis pressez entrer"
        << std::endl
    ...
    case 1: {
      ...
      std::cout
          << std::endl
          << "Indiquez le nom du fichier que l'on doit charger tel quel : ";
      try {
        /** Récupérer l'entrée utilisateur correspondant au fichier selectionné
         * et créer la carte à l'aide du constructeur */
        std::cin >> file_name;
    ...
    case 2: {
      ...
      std::cout
          << std::endl
          << "Indiquez le numero de la parcelle du polygone a translater : ";
    ...
    case 3:
      ...
      std::cout << std::endl
                << "Indiquez le nom du fichier que l'on doit enregistrer : ";
      std::cin >> file_name;
    ...
    default:
      ...
      std::cout << "Valeur doit-être comprise entre 0 et 4" << std::endl;
      break;
    }
  }
}
